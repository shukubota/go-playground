...
const (
	...
	Greeter_SayHelloBiDirectionalStream_FullMethodName = "/hello.Greeter/SayHelloBiDirectionalStream"
	Greeter_SayHelloServerStream_FullMethodName        = "/hello.Greeter/SayHelloServerStream"
)
...
func (c *greeterClient) SayHelloBiDirectionalStream(ctx context.Context, opts ...grpc.CallOption) (Greeter_SayHelloBiDirectionalStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[0], Greeter_SayHelloBiDirectionalStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
