...
const (
	DrawingShare_Connect_FullMethodName     = "/drawing_share.DrawingShare/Connect"
	DrawingShare_SendDrawing_FullMethodName = "/drawing_share.DrawingShare/SendDrawing"
	DrawingShare_DisConnect_FullMethodName  = "/drawing_share.DrawingShare/DisConnect"
)
...
func (c *drawingShareClient) Connect(ctx context.Context, in *ConnectRequest, opts ...grpc.CallOption) (DrawingShare_ConnectClient, error) {
	stream, err := c.cc.NewStream(ctx, &DrawingShare_ServiceDesc.Streams[0], DrawingShare_Connect_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *drawingShareClient) SendDrawing(ctx context.Context, in *SendDrawingRequest, opts ...grpc.CallOption) (*SendDrawingResponse, error) {
	...
	err := c.cc.Invoke(ctx, DrawingShare_SendDrawing_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drawingShareClient) DisConnect(ctx context.Context, in *DisConnectRequest, opts ...grpc.CallOption) (*DisConnectResponse, error) {
	...
	err := c.cc.Invoke(ctx, DrawingShare_DisConnect_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DrawingShare_SendDrawing_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DrawingShare_SendDrawing_FullMethodName,
	}
...
func _DrawingShare_DisConnect_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DrawingShare_DisConnect_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
