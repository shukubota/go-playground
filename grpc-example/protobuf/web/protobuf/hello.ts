...
export namespace hello {
    ...
    export abstract class UnimplementedGreeterService {
        static definition = {
            ...
            SayHelloBiDirectionalStream: {
                path: "/hello.Greeter/SayHelloBiDirectionalStream",
                requestStream: true,
                responseStream: true,
                requestSerialize: (message: HelloRequest) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => HelloRequest.deserialize(new Uint8Array(bytes)),
            ...
            SayHelloServerStream: {
                path: "/hello.Greeter/SayHelloServerStream",
                requestStream: false,
                responseStream: true,
                requestSerialize: (message: HelloRequest) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => HelloRequest.deserialize(new Uint8Array(bytes)),
        ...
        abstract SayHelloBiDirectionalStream(call: grpc_1.ServerDuplexStream<HelloRequest, HelloReply>): void;
        abstract SayHelloServerStream(call: grpc_1.ServerWritableStream<HelloRequest, HelloReply>): void;
    }
    export class GreeterClient extends grpc_1.makeGenericClientConstructor(UnimplementedGreeterService.definition, "Greeter", {}) {
        ...
        SayHelloBiDirectionalStream: GrpcChunkServiceInterface<HelloRequest, HelloReply> = (metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): grpc_1.ClientDuplexStream<HelloRequest, HelloReply> => {
            return super.SayHelloBiDirectionalStream(metadata, options);
        };
        SayHelloServerStream: GrpcStreamServiceInterface<HelloRequest, HelloReply> = (message: HelloRequest, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): grpc_1.ClientReadableStream<HelloReply> => {
            return super.SayHelloServerStream(message, metadata, options);
        };
    }
}
